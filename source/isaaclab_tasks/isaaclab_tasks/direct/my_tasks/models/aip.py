...
def instantiate_AIP(env, params: int=1, device: torch.device | None=None):
    models = {}
    ...
    models["interaction discriminator"] = Discriminator(env.amp_inter_observation_size, env.action_space.shape[0], params=params, device=device)
    return models